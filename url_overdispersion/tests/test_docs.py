...
def test_readme_documents_telemetry_env_vars() -> None:
    ...
    for env_var in [
        'URL_OVERDISPERSION_OTEL_ENABLED',
        'URL_OVERDISPERSION_OTEL_SERVICE_NAME',
        'URL_OVERDISPERSION_OTEL_SERVICE_VERSION',
        'URL_OVERDISPERSION_OTEL_ENVIRONMENT',
...
def test_docs_mention_high_cardinality_guardrails() -> None:
    ...
    for term in ['domain', 'sample_urls', 'sample_dids']:
        assert term in text
